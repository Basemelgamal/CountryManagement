                ...
                <thead class="thead-light">
                    <tr>
                        ...
                        @foreach ($locales as $locale)
                            <th scope="col">{{ 'Title '.$locale->name  }}</th>
                            <th scope="col">{{ 'Description '.$locale->name }}</th>
                        @endforeach
                    ...
                    @foreach ($countries as $country)
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-icon btn-light btn-hover-danger btn-sm delete" onclick="Delete('{{ $country->id }}')">
